...
## What is Apache Hudi[​](#what-is-apache-hudi "Direct link to What is Apache Hudi")
...
Hudi brings core database functionality directly to a data lake - [tables](/docs/sql_ddl),
[transactions](/docs/timeline), [efficient upserts/deletes](/docs/write_operations), [advanced indexes](/docs/indexes),
[ingestion services](/docs/hoodie_streaming_ingestion), data [clustering](/docs/clustering)/[compaction](/docs/compaction) optimizations,
and [concurrency control](/docs/concurrency_control) all while keeping your data in open file formats. Not only is Apache Hudi great for streaming workloads,
...
## Core Concepts to Learn[​](#core-concepts-to-learn "Direct link to Core Concepts to Learn")
...
* [Hudi File Layout](/docs/storage_layouts) - How the files are laid out on storage
...
## Connect With The Community[​](#connect-with-the-community "Direct link to Connect With The Community")
...
### Join in on discussions[​](#join-in-on-discussions "Direct link to Join in on discussions")
...
### Come to Office Hours for help[​](#come-to-office-hours-for-help "Direct link to Come to Office Hours for help")

Weekly office hours are [posted here](/community/office_hours)

### Community Calls[​](#community-calls "Direct link to Community Calls")
...
* [Core Concepts to Learn](#core-concepts-to-learn)
* [Getting Started](#getting-started)
* [Connect With The Community](#connect-with-the-community)
  * [Join in on discussions](#join-in-on-discussions)
  * [Come to Office Hours for help](#come-to-office-hours-for-help)
